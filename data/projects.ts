...
export const projectsData: ProjectCaseStudy[] = [
  {
    ...
    tools: ["Total Station", "Auto Level", "AutoCAD", "MS Excel (BBS)", "Rotary Piling Rig", "Cube Testing Machine"],
    image: "/images/site/site-24.jpg",
    summary:
      "Comprehensive site engineering and geomatic alignment for large-scale reinforced concrete wastewater treatment units, aeration tanks, deep excavations, and heavy piping networks.",
    facts: [
      { label: "PROJECT TYPE", value: "Sanitary / Heavy RCC Infrastructure" },
      { label: "LOCATION", value: "Tokha-07, Kathmandu, Nepal" },
      { label: "CONTRACTOR", value: "Sarathi Construction Pvt. Ltd." },
      { label: "ROLE", value: "Civil Site Engineer & Field Surveyor" },
      { label: "WORKFORCE", value: "40–50 Site Laborers & Specialized Trades" },
      { label: "CORE FOCUS", value: "Setting Out, BBS, Concreting & Testing" },
    ],
    overview:
      "The Tokha Wastewater Treatment Plant project is a vital municipal environmental infrastructure initiative designed to collect, treat, and safely discharge wastewater in northern Kathmandu. The structural works demanded exceptionally stringent water-tight concrete specifications, strict reinforcement cover controls, and zero tolerance for benchmark deviation in foundation tanks.",
    myRole:
      "Directly led on-site survey operations and day-to-day engineering execution. Responsible for horizontal and vertical setting out using Total Station, structural drawing verification, reinforcement inspection, quality testing of aggregates and fresh concrete, and workforce deployment.",
    responsibilities: [
    ...
    sitePhotos: [
      { caption: "Complete aeration tank formwork and vertical wall rebar shuttering", stage: "Formwork & Shuttering", image: "/images/site/site-24.jpg" },
      { caption: "Massive RCC raft reinforcement mat inspection with perimeter drainage", stage: "Raft Slab Rebar", image: "/images/site/site-28.jpg" },
      { caption: "Hydro-expansive PVC water-stop seal installation at wall cold joint", stage: "Waterproofing Joint", image: "/images/site/site-32.jpg" },
      { caption: "Standard 150mm concrete test cubes with casting batch labels", stage: "Compressive QC Test", image: "/images/site/site-05.jpg" },
    ],
  },
  {
    ...
    tools: ["Rotary Piling Rig", "Total Station", "Tremie Pipe", "Concrete Transit Mixers", "Slump Cone"],
    image: "/images/site/site-44.jpg",
    summary:
      "Execution of deep cast-in-situ concrete piles for heavy structural foundation support in alluvial soil conditions with groundwater table control.",
    facts: [
      { label: "FOUNDATION TYPE", value: "Bored Cast-in-Situ Reinforced Piles" },
      { label: "LOCATION", value: "Tokha Site, Kathmandu" },
      { label: "EQUIPMENT", value: "Hydraulic Crawler Rotary Piling Rig" },
      { label: "ROLE", value: "Site Inspection & Borehole Alignment" },
      { label: "POUR METHOD", value: "Submerged Tremie Pipe Concreting" },
      { label: "CHALLENGE", value: "Alluvial Silt & Night Logistics" },
    ],
    overview:
      "Deep foundation piles were required to transfer heavy superstructure and hydraulic tank loads through soft upper alluvial strata down to competent load-bearing strata. Operations encompassed mechanical auger boring, bentonite slurry stabilization, lowering 12m-long circular rebar cages with cover spacers, and tremie underwater concreting.",
    myRole:
      "Monitored borehole verticality, checked drill depth, inspected circular rebar cage tying, ensured cover block spacer placement, and supervised continuous tremie concrete pouring.",
    responsibilities: [
    ...
    sitePhotos: [
      { caption: "Rotary hydraulic piling rig hoisting circular rebar cage with spacers", stage: "Cage Lowering", image: "/images/site/site-44.jpg" },
      { caption: "Night concreting and pile cage alignment under floodlights", stage: "Night Concreting", image: "/images/site/site-46.jpg" },
      { caption: "Borehole drilling rig setup and workforce briefing", stage: "Rig Alignment", image: "/images/site/site-40.jpg" },
    ],
  },
  {
    ...
    tools: ["AutoCAD 2D", "MS Excel", "Nepal National Building Code (NBC)", "Auto Level"],
    image: "/images/site/site-36.jpg",
    summary:
      "Preparation of comprehensive architectural floor plans, municipal sanction drawings, foundation layouts, and site shuttering inspection for urban residential buildings.",
    facts: [
      { label: "PROJECT TYPE", value: "Residential RCC Frame Structures" },
      { label: "LOCATION", value: "Kathmandu Valley, Nepal" },
      { label: "STANDARDS", value: "Nepal National Building Code (NBC 105 / 205)" },
      { label: "ROLE", value: "Drafting & Site Inspection" },
      { label: "KEY FOCUS", value: "Column Detailing, Shuttering & BOQ" },
    ],
    overview:
      "Urban housing in Nepal requires rigorous compliance with the Nepal National Building Code (NBC), seismic detailing mandates, and municipal bylaws. At Ujyalo Engineering Consultancy and associated residential sites, I contributed to municipal permit sets, developing structural framing layouts, and inspecting column formwork shuttering.",
    myRole:
      "Assisted with 2D drafting, structural detailing of isolated column footings, plinth beams, staircase reinforcement, and checking column formwork plumbness and tie bracing on site.",
    responsibilities: [
    ...
    sitePhotos: [
      { caption: "Column shuttering box with diagonal steel props and tie clamps", stage: "Formwork Check", image: "/images/site/site-36.jpg" },
      { caption: "Wall reinforcement cages and scaffolding setup", stage: "Rebar Detailing", image: "/images/site/site-20.jpg" },
    ],
  },
  {
    id: "survey-geomatics",
    ...
    tools: ["Electronic Total Station", "Auto Level", "Prism Poles", "AutoCAD Civil", "Excel"],
    image: "/images/site/site-10.jpg",
    summary:
      "Precision geodetic setting out, closed-traverse surveying, level network establishment, and construction alignment across wide excavation sites.",
    facts: [
      { label: "INSTRUMENTS", value: "Total Station, Auto Level, Digital Theodolite" },
      { label: "ACCURACY", value: "High-precision second-order leveling" },
      { label: "OPERATIONS", value: "Traverse, Staking, Longitudinal Profiles" },
      { label: "APPLICATIONS", value: "Tanks, Trenches, Roads & Pipelines" },
    ],
    overview:
      "Accurate geodetic control is the foundation of any civil engineering project. This ongoing practice covers the field execution of closed traverses, high-accuracy Auto Level loops, structural center-line marking, and pipeline invert gradient control under challenging site conditions.",
    myRole:
      "Lead instrumentalist and site surveyor. Setting instrument stations, performing backsight/foresight checks, computing coordinates, and physically staking out construction center lines.",
    responsibilities: [
    ...
    sitePhotos: [
      { caption: "Wide excavation bed setting out with center-line string lines and pegs", stage: "Site Setting Out", image: "/images/site/site-10.jpg" },
      { caption: "Structural steel rebar delivery inspection with logistics team", stage: "Material Delivery", image: "/images/site/site-08.jpg" },
    ],
  },
  {
    ...
    tools: ["ETABS", "AutoCAD 2D", "MS Excel", "IS 1893:2016", "IS 456:2000", "NBC 105:2020"],
    image: "/images/site/site-20.jpg",
    summary:
      "Comprehensive structural analysis and ductile seismic design of a multi-storey commercial-residential reinforced concrete framed building following Nepal National Building Code (NBC 105:2020).",
    facts: [
      { label: "PROJECT TYPE", value: "Academic Capstone / Structural Analysis" },
      { label: "INSTITUTION", value: "Lumbini Engineering College (Pokhara Univ.)" },
      { label: "FRAMING SYSTEM", value: "Special Moment Resisting Frame (SMRF)" },
      { label: "SOFTWARE", value: "ETABS v19 & AutoCAD" },
      { label: "SEISMIC CODE", value: "NBC 105:2020 & IS 1893:2016" },
      { label: "FOCUS", value: "Base Shear, Inter-Storey Drift & Ductile Detailing" },
    ],
    overview:
      "As the final year capstone thesis at Lumbini Engineering, Management and Science College (affiliated with Pokhara University), this project delivered an end-to-end structural design of a multi-storey reinforced concrete framed building situated in high-seismicity zone Nepal. The investigation encompassed architectural grid harmonization, preliminary member sizing, dead and live load assessments, Equivalent Static and Response Spectrum dynamic seismic analyses in ETABS, member design, and ductile reinforcement detailing.",
    myRole:
      "Spearheaded 3D finite element structural modeling in ETABS, defined material grades (M25 concrete, Fe500 steel), assigned diaphragm constraints, verified modal participation mass ratios, calculated design base shears, and prepared structural detailing sheets.",
    responsibilities: [
    ...
    sitePhotos: [
      { caption: "Reinforced concrete wall and frame reinforcement detailing check", stage: "Structural Execution", image: "/images/site/site-20.jpg" },
      { caption: "Column shuttering and vertical alignment verification on residential frame build", stage: "Frame Supervision", image: "/images/site/site-36.jpg" },
    ],
  },
];
