...
export const experienceData: ExperienceItem[] = [
  {
    ...
    "description": "Leading on-site engineering execution, setting out, and quality control on heavy reinforced concrete wastewater treatment plant units, tanks, and underground pipeline installations.",
    "achievements": [
  ...
  },
  {
    ...
    "description": "Contributed to architectural 2D drafting, structural drawing preparation, foundation planning, and quantity estimation for residential buildings under the supervision of senior engineers.",
    "achievements": [
