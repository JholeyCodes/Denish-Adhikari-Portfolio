...
export const skillsData: SkillCategory[] = [
  ...
  },
  {
    ...
    "skills": [
      ...
      {
        "name": "Daily Progress Reporting",
        "note": "Compiling DPRs, labor logs, equipment hours & site weather"
      },
      {
        "name": "Site Safety & PPE",
        "note": "Enforcing hard hats, safety boots, excavation barricading"
      },
      {
        "name": "Subcontractor Coordination",
        "note": "Supervising specialized trades: rebar benders, masons, carpenters"
      }
    ]
  }
];
